...
SUBSCRIBER_DISCOUNT_RATE = config('SUBSCRIBER_DISCOUNT_RATE', default='0.15')
SUBSCRIPTION_PRICE_MONTHLY = config('SUBSCRIPTION_PRICE_MONTHLY', default='9.99')
SUBSCRIPTION_PRICE_YEARLY = config('SUBSCRIPTION_PRICE_YEARLY', default='99.99')
